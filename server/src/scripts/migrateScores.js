...
function migrateScores() {
    return __awaiter(this, void 0, void 0, function () {
        var games, _i, games_1, game, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Game_1.Game.find({})];
                case 2:
                    games = _a.sent();
                    console.log("Found ".concat(games.length, " games to migrate"));
                    _i = 0, games_1 = games;
                    _a.label = 3;
                case 3:
                ...
                case 4:
                    _a.sent();
                    console.log("Migrated game ".concat(game.gameId));
                    _a.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 3];
